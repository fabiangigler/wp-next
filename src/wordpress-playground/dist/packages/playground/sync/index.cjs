"use strict";Object.defineProperty(exports,Symbol.toStringTag,{value:"Module"});const q=function(){var n;return typeof process<"u"&&((n=process.release)==null?void 0:n.name)==="node"?"NODE":typeof window<"u"?"WEB":typeof WorkerGlobalScope<"u"&&self instanceof WorkerGlobalScope?"WORKER":"NODE"}();if(q==="NODE"){let n=function(t){return new Promise(function(r,s){t.onload=t.onerror=function(o){t.onload=t.onerror=null,o.type==="load"?r(t.result):s(new Error("Failed to read the blob/file"))}})},e=function(){const t=new Uint8Array([1,2,3,4]),s=new File([t],"test").stream();try{return s.getReader({mode:"byob"}),!0}catch{return!1}};if(typeof File>"u"){class t extends Blob{constructor(s,o,a){super(s);let i;a!=null&&a.lastModified&&(i=new Date),(!i||isNaN(i.getFullYear()))&&(i=new Date),this.lastModifiedDate=i,this.lastModified=i.getMilliseconds(),this.name=o||""}}global.File=t}typeof Blob.prototype.arrayBuffer>"u"&&(Blob.prototype.arrayBuffer=function(){const r=new FileReader;return r.readAsArrayBuffer(this),n(r)}),typeof Blob.prototype.text>"u"&&(Blob.prototype.text=function(){const r=new FileReader;return r.readAsText(this),n(r)}),(typeof Blob.prototype.stream>"u"||!e())&&(Blob.prototype.stream=function(){let t=0;const r=this;return new ReadableStream({type:"bytes",autoAllocateChunkSize:512*1024,async pull(s){const o=s.byobRequest.view,i=await r.slice(t,t+o.byteLength).arrayBuffer(),l=new Uint8Array(i);new Uint8Array(o.buffer).set(l);const m=l.byteLength;s.byobRequest.respond(m),t+=m,t>=r.size&&s.close()}})})}if(q==="NODE"&&typeof CustomEvent>"u"){class n extends Event{constructor(t,r={}){super(t,r),this.detail=r.detail}initCustomEvent(){}}globalThis.CustomEvent=n}const x="playground-log",b=(n,...e)=>{f.dispatchEvent(new CustomEvent(x,{detail:{log:n,args:e}}))},M=(n,...e)=>{switch(typeof n.message=="string"?n.message=_(n.message):n.message.message&&typeof n.message.message=="string"&&(n.message.message=_(n.message.message)),n.severity){case"Debug":console.debug(n.message,...e);break;case"Info":console.info(n.message,...e);break;case"Warn":console.warn(n.message,...e);break;case"Error":console.error(n.message,...e);break;case"Fatal":console.error(n.message,...e);break;default:console.log(n.message,...e)}},P=n=>n instanceof Error?[n.message,n.stack].join(`
`):JSON.stringify(n,null,2),S=[],T=n=>{S.push(n)},h=n=>{if(n.raw===!0)T(n.message);else{const e=W(typeof n.message=="object"?P(n.message):n.message,n.severity??"Info",n.prefix??"JavaScript");T(e)}};class B extends EventTarget{constructor(e=[]){super(),this.handlers=e,this.fatalErrorEvent="playground-fatal-error"}getLogs(){return this.handlers.includes(h)?[...S]:(this.error(`Logs aren't stored because the logToMemory handler isn't registered.
				If you're using a custom logger instance, make sure to register logToMemory handler.
			`),[])}logMessage(e,...t){for(const r of this.handlers)r(e,...t)}log(e,...t){this.logMessage({message:e,severity:void 0,prefix:"JavaScript",raw:!1},...t)}debug(e,...t){this.logMessage({message:e,severity:"Debug",prefix:"JavaScript",raw:!1},...t)}info(e,...t){this.logMessage({message:e,severity:"Info",prefix:"JavaScript",raw:!1},...t)}warn(e,...t){this.logMessage({message:e,severity:"Warn",prefix:"JavaScript",raw:!1},...t)}error(e,...t){this.logMessage({message:e,severity:"Error",prefix:"JavaScript",raw:!1},...t)}}const Q=()=>{try{if(process.env.NODE_ENV==="test")return[h,b]}catch{}return[h,M,b]},f=new B(Q()),_=n=>n.replace(/\t/g,""),W=(n,e,t)=>{const r=new Date,s=new Intl.DateTimeFormat("en-GB",{year:"numeric",month:"short",day:"2-digit",timeZone:"UTC"}).format(r).replace(/ /g,"-"),o=new Intl.DateTimeFormat("en-GB",{hour:"2-digit",minute:"2-digit",second:"2-digit",hour12:!1,timeZone:"UTC",timeZoneName:"short"}).format(r),a=s+" "+o;return n=_(n),`[${a}] ${t} ${e}: ${n}`},j=`<?php
...
playground_sync_start();`,v=Symbol("SleepFinished");function G(n){return new Promise(e=>{setTimeout(()=>e(v),n)})}class U extends Error{constructor(){super("Acquiring lock timed out")}}class J{constructor({concurrency:e,timeout:t}){this._running=0,this.concurrency=e,this.timeout=t,this.queue=[]}get remaining(){return this.concurrency-this.running}get running(){return this._running}async acquire(){for(;;)if(this._running>=this.concurrency){const e=new Promise(t=>{this.queue.push(t)});this.timeout!==void 0?await Promise.race([e,G(this.timeout)]).then(t=>{if(t===v)throw new U}):await e}else{this._running++;let e=!1;return()=>{e||(e=!0,this._running--,this.queue.length>0&&this.queue.shift()())}}}async run(e){const t=await this.acquire();try{return await e()}finally{t()}}}function g(...n){let e=n.join("/");const t=e[0]==="/",r=e.substring(e.length-1)==="/";return e=R(e),!e&&!t&&(e="."),e&&r&&(e+="/"),e}function H(n){if(n==="/")return"/";n=R(n);const e=n.lastIndexOf("/");return e===-1?"":e===0?"/":n.substr(0,e)}function R(n){const e=n[0]==="/";return n=z(n.split("/").filter(t=>!!t),!e).join("/"),(e?"/":"")+n.replace(/\/$/,"")}function z(n,e){let t=0;for(let r=n.length-1;r>=0;r--){const s=n[r];s==="."?n.splice(r,1):s===".."?(n.splice(r,1),t++):t&&(n.splice(r,1),t--)}if(e)for(;t;t--)n.unshift("..");return n}function w(n){return`json_decode(base64_decode('${K(JSON.stringify(n))}'), true)`}function Y(n){const e={};for(const t in n)e[t]=w(n[t]);return e}function K(n){return V(new TextEncoder().encode(n))}function V(n){const e=String.fromCodePoint(...n);return btoa(e)}async function I(n){await n.fileExists("/wordpress/wp-content/mu-plugins")||await n.mkdir("/wordpress/wp-content/mu-plugins"),await n.writeFile("/wordpress/wp-content/mu-plugins/sync-mu-plugin.php",j)}async function L(n,e,t={}){const r=await n.run({code:`<?php
        require '/wordpress/wp-load.php';
        playground_sync_override_autoincrement_algorithm(
			${w(e)},
			${w(t)}
		);
	    `});return O(r,"Initialization failed."),(await n.run({code:`<?php
        require '/wordpress/wp-load.php';
		$data = $GLOBALS['@pdo']
			->query('SELECT * FROM playground_sequence')
			->fetchAll(PDO::FETCH_KEY_PAIR);
		echo json_encode($data);
		`})).json}async function A(n,e){let t=null;n.addEventListener("request.end",()=>{t=null}),n.onMessage(async r=>{const s=JSON.parse(r);if((s==null?void 0:s.type)==="sql"){if(s.subtype==="transaction"){const o=s;if(!o.success)return;switch(o.command){case"START TRANSACTION":t=[];break;case"COMMIT":t!=null&&t.length&&t.forEach(e),t=null;break;case"ROLLBACK":t=null;break}return}if(s.subtype==="replay-query"||s.subtype==="reconstruct-insert"){const o=s;t?t.push(o):e(o)}}})}async function N(n,e){const t=Y({journal:e}),r=await n.run({code:`<?php
	...
	`});O(r,"Replay error.")}function O(n,e){if(n.text.trim()||n.errors.trim())throw f.error({text:n.text,errors:n.errors}),new Error(`${e}. See the console for more details.`)}async function C(n,e){await n.journalFSEvents("/wordpress/wp-content",async t=>{t.path.endsWith("/.ht.sqlite")||t.path.endsWith("/.ht.sqlite-journal")||e(t)})}class X{sendChanges(e){window.top.postMessage({type:"playground-change",envelope:e},"*")}onChangesReceived(e){window.addEventListener("message",t=>{t.data.type==="playground-change"&&e(t.data.envelope)})}}class Z{sendChanges(){}onChangesReceived(e){this.injectChanges=e}injectChanges(e){}}const ee=n=>({beforeSend:e=>({...e,sql:e.sql.map(t=>(t.subtype==="reconstruct-insert"&&n(t.table_name,t.last_insert_id),t))}),afterReceive:e=>e});function ne(n){return{beforeSend:e=>((e.sql.length>0||e.fs.length>0)&&f.log(`[${n}] Sending changes`,e),e),afterReceive:e=>(f.log(`[${n}] Received changes`,e),e)}}const D=(n,e="https://playground.wordpress.net")=>({beforeSend:$(n,e),afterReceive:$(e,n)});function $(n,e){n=n.replace(/\/$/,""),e=e.replace(/\/$/,"");const t=new RegExp(`(^|[^0-9a-zA-Z])(?:${te(n)})($|[^0-9a-zA-Z])`,"g"),r=`$1${e}$2`;return s=>({...s,sql:s.sql.map(o=>{if(o.subtype==="replay-query")return{...o,query:o.query.replace(n,e)};if(o.subtype==="reconstruct-insert"){const a={...o.row};for(const i in a)typeof a[i]=="string"&&(a[i]=a[i].replace(t,r));return{...o,row:a}}return o})})}function te(n){return n.replace(/[/\-\\^$*+?.()|[\]{}]/g,"\\$&")}const re=()=>({beforeSend:n=>({...n,sql:n.sql.filter(se)}),afterReceive:n=>n}),se=n=>{var r;if(n.query_type==="SELECT")return!1;const e=n.query_type,t=(r=n.table_name)==null?void 0:r.toLowerCase();if(n.subtype==="replay-query"){const s=n.query.trim();if(e==="UPDATE"&&t==="wp_options"&&s.endsWith("`option_name` = 'cron'"))return!1}if(n.subtype==="reconstruct-insert"){if(t==="wp_options"){const s=n.row.option_name+"";if(s.startsWith("_transient_")||s.startsWith("_site_transient_"))return!1}if(t==="wp_usermeta"&&n.row.meta_key==="session_tokens")return!1}return!0},y={0:"No error occurred. System call completed successfully.",1:"Argument list too long.",2:"Permission denied.",3:"Address in use.",4:"Address not available.",5:"Address family not supported.",6:"Resource unavailable, or operation would block.",7:"Connection already in progress.",8:"Bad file descriptor.",9:"Bad message.",10:"Device or resource busy.",11:"Operation canceled.",12:"No child processes.",13:"Connection aborted.",14:"Connection refused.",15:"Connection reset.",16:"Resource deadlock would occur.",17:"Destination address required.",18:"Mathematics argument out of domain of function.",19:"Reserved.",20:"File exists.",21:"Bad address.",22:"File too large.",23:"Host is unreachable.",24:"Identifier removed.",25:"Illegal byte sequence.",26:"Operation in progress.",27:"Interrupted function.",28:"Invalid argument.",29:"I/O error.",30:"Socket is connected.",31:"There is a directory under that path.",32:"Too many levels of symbolic links.",33:"File descriptor value too large.",34:"Too many links.",35:"Message too large.",36:"Reserved.",37:"Filename too long.",38:"Network is down.",39:"Connection aborted by network.",40:"Network unreachable.",41:"Too many files open in system.",42:"No buffer space available.",43:"No such device.",44:"There is no such file or directory OR the parent directory does not exist.",45:"Executable file format error.",46:"No locks available.",47:"Reserved.",48:"Not enough space.",49:"No message of the desired type.",50:"Protocol not available.",51:"No space left on device.",52:"Function not supported.",53:"The socket is not connected.",54:"Not a directory or a symbolic link to a directory.",55:"Directory not empty.",56:"State not recoverable.",57:"Not a socket.",58:"Not supported, or operation not supported on socket.",59:"Inappropriate I/O control operation.",60:"No such device or address.",61:"Value too large to be stored in data type.",62:"Previous owner died.",63:"Operation not permitted.",64:"Broken pipe.",65:"Protocol error.",66:"Protocol not supported.",67:"Protocol wrong type for socket.",68:"Result too large.",69:"Read-only file system.",70:"Invalid seek.",71:"No such process.",72:"Reserved.",73:"Connection timed out.",74:"Text file busy.",75:"Cross-device link.",76:"Extension: Capabilities insufficient."};function oe(n){const e=typeof n=="object"?n==null?void 0:n.errno:null;if(e in y)return y[e]}function c(n=""){return function(t,r,s){const o=s.value;s.value=function(...a){try{return o.apply(this,a)}catch(i){const l=typeof i=="object"?i==null?void 0:i.errno:null;if(l in y){const m=y[l],E=typeof a[1]=="string"?a[1]:null,F=E!==null?n.replaceAll("{path}",E):n;throw new Error(`${F}: ${m}`,{cause:i})}throw i}}}}var ae=Object.defineProperty,ie=Object.getOwnPropertyDescriptor,d=(n,e,t,r)=>{for(var s=r>1?void 0:r?ie(e,t):e,o=n.length-1,a;o>=0;o--)(a=n[o])&&(s=(r?a(e,t,s):a(s))||s);return r&&s&&ae(e,t,s),s};const p=class u{static readFileAsText(e,t){return new TextDecoder().decode(u.readFileAsBuffer(e,t))}static readFileAsBuffer(e,t){return e.readFile(t)}static writeFile(e,t,r){e.writeFile(t,r)}static unlink(e,t){e.unlink(t)}static mv(e,t,r){try{const s=e.lookupPath(t).node.mount,o=u.fileExists(e,r)?e.lookupPath(r).node.mount:e.lookupPath(H(r)).node.mount;s.mountpoint!==o.mountpoint?(u.copyRecursive(e,t,r),u.rmdir(e,t,{recursive:!0})):e.rename(t,r)}catch(s){const o=oe(s);throw o?new Error(`Could not move ${t} to ${r}: ${o}`,{cause:s}):s}}static rmdir(e,t,r={recursive:!0}){r!=null&&r.recursive&&u.listFiles(e,t).forEach(s=>{const o=`${t}/${s}`;u.isDir(e,o)?u.rmdir(e,o,r):u.unlink(e,o)}),e.rmdir(t)}static listFiles(e,t,r={prependPath:!1}){if(!u.fileExists(e,t))return[];try{const s=e.readdir(t).filter(o=>o!=="."&&o!=="..");if(r.prependPath){const o=t.replace(/\/$/,"");return s.map(a=>`${o}/${a}`)}return s}catch(s){return f.error(s,{path:t}),[]}}static isDir(e,t){return u.fileExists(e,t)?e.isDir(e.lookupPath(t).node.mode):!1}static fileExists(e,t){try{return e.lookupPath(t),!0}catch{return!1}}static mkdir(e,t){e.mkdirTree(t)}static copyRecursive(e,t,r){const s=e.lookupPath(t).node;if(e.isDir(s.mode)){e.mkdirTree(r);const o=e.readdir(t).filter(a=>a!=="."&&a!=="..");for(const a of o)u.copyRecursive(e,g(t,a),g(r,a))}else e.writeFile(r,e.readFile(t))}};d([c('Could not read "{path}"')],p,"readFileAsText",1);d([c('Could not read "{path}"')],p,"readFileAsBuffer",1);d([c('Could not write to "{path}"')],p,"writeFile",1);d([c('Could not unlink "{path}"')],p,"unlink",1);d([c('Could not remove directory "{path}"')],p,"rmdir",1);d([c('Could not list files in "{path}"')],p,"listFiles",1);d([c('Could not stat "{path}"')],p,"isDir",1);d([c('Could not stat "{path}"')],p,"fileExists",1);d([c('Could not create directory "{path}"')],p,"mkdir",1);d([c('Could not copy files from "{path}"')],p,"copyRecursive",1);(function(){var n;return typeof process<"u"&&((n=process.release)==null?void 0:n.name)==="node"?"NODE":typeof window<"u"?"WEB":typeof WorkerGlobalScope<"u"&&self instanceof WorkerGlobalScope?"WORKER":"NODE"})();ReadableStream.prototype[Symbol.asyncIterator]||(ReadableStream.prototype[Symbol.asyncIterator]=async function*(){const n=this.getReader();try{for(;;){const{done:e,value:t}=await n.read();if(e)return;yield t}}finally{n.releaseLock()}},ReadableStream.prototype.iterate=ReadableStream.prototype[Symbol.asyncIterator]);function k(n){const e={};for(let t=n.length-1;t>=0;t--){for(let r=t-1;r>=0;r--){const s=le(n[t],n[r]);if(s==="none")continue;const o=n[t],a=n[r];if(o.operation==="RENAME"&&a.operation==="RENAME"){f.warn("[FS Journal] Normalizing a double rename is not yet supported:",{current:o,last:a});continue}(a.operation==="CREATE"||a.operation==="WRITE")&&(o.operation==="RENAME"?s==="same_node"?(e[r]=[],e[t]=[{...a,path:o.toPath},...e[t]||[]]):s==="descendant"&&(e[r]=[],e[t]=[{...a,path:g(o.toPath,a.path.substring(o.path.length))},...e[t]||[]]):o.operation==="WRITE"&&s==="same_node"?e[r]=[]:o.operation==="DELETE"&&s==="same_node"&&(e[r]=[],e[t]=[]))}if(Object.entries(e).length>0){const r=n.flatMap((s,o)=>o in e?e[o]:[s]);return k(r)}}return n}function le(n,e){const t=n.path,r=n.operation!=="WRITE"&&n.nodeType==="directory",s=e.operation!=="WRITE"&&e.nodeType==="directory",o=e.operation==="RENAME"?e.toPath:e.path;return o===t?"same_node":s&&t.startsWith(o+"/")?"ancestor":r&&o.startsWith(t+"/")?"descendant":"none"}async function ue(n,e){const r=e.filter(s=>s.operation==="WRITE").map(s=>de(n,s));return await Promise.all(r),e}const ce=new J({concurrency:15});async function de(n,e){const t=await ce.acquire();try{e.data=await n.readFileAsBuffer(e.path)}catch(r){f.warn(`Journal failed to hydrate a file on flush: the path ${e.path} no longer exists`),f.error(r)}t()}const pe=n=>({beforeSend:async e=>({...e,fs:await ue(n,k(e.fs))}),afterReceive:e=>e});async function fe(n,{autoincrementOffset:e,transport:t,middlewares:r=[]}){r=[re(),D(await n.absoluteUrl),pe(n),...r],await I(n),await L(n,e),t.onChangesReceived(async i=>{for(const l of r)i=await l.afterReceive(i);await n.replayFSJournal(i.fs),await N(n,i.sql)});let s={fs:[],sql:[]};A(n,i=>{s.sql.push(i)}),C(n,i=>{s.fs.push(i)});const o=async()=>{let i=s;s={fs:[],sql:[]};for(const l of r)i=await l.beforeSend(i);!i.sql.length&&!i.fs.length||t.sendChanges(i)},a=async(i,l)=>{await i(),setTimeout(a,l,i,l)};a(o,3e3)}exports.NoopTransport=Z;exports.ParentWindowTransport=X;exports.installSqlSyncMuPlugin=I;exports.journalFSOperations=C;exports.journalSQLQueries=A;exports.loggerMiddleware=ne;exports.marshallSiteURLMiddleware=D;exports.overrideAutoincrementSequences=L;exports.replaySQLJournal=N;exports.setupPlaygroundSync=fe;exports.trackAutoincrementMiddleware=ee;
